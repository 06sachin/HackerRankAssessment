...
//            return (movie.title?.localizedCaseInsensitiveContains(query) ?? false) ||
//            (movie.genre?.localizedCaseInsensitiveContains(query) ?? false) ||
//            (movie.director?.localizedCaseInsensitiveContains(query) ?? false) ||
//            (movie.actors?.localizedCaseInsensitiveContains(query) ?? false)
//        }
//    }
//
...
//    }
//
//    // Toggle expand/collapse state of a section
//    func toggleSection(_ section: SectionType) {
//        expandedSections[section]?.toggle()
//    }
//
...
//    }
//
//    // Fetch movies by a specific category and value
//    func movies(for category: SectionType, with value: String) -> [MoviesData] {
//        return movies.filter { movie in
//            switch category {
//            case .year:
